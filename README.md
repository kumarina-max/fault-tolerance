...
```
### Балансировщик и целевая группа (активны, здоровы)

![Балансировщик](screenshots/Скриншот%20статуса%20балансировщика%20и%20целевой%20группы..png)

### Страница Nginx по IP балансировщика

![Nginx](screenshots/Скриншот%20страницы%2C%20которая%20открылась%20при%20запросе%20IP-адреса%20балансировщика%0A.png)
